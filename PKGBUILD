...
package() {
  ...
  install -m644 "${srcdir}/fw-0a5c-21d7.hcd" "${pkgdir}/usr/lib/firmware/fw-0a5c-21d7.hcd"
  install -m644 "${srcdir}/fw-0a5c-21d7.hcd" "${pkgdir}/usr/lib/firmware/brcm/BCM.hcd"
}
